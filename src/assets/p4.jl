...
Alice wants to send Bob two classical bits of information. That means, one of the four states 00, 01, 10, 11. How does she do this?
...
Assume you've the a qubit q and you want to measure it, the syntax is q |> r->measure(r, nshots=number_of_runs)
...
If you don't get that, just know the syntax and keep nshots=1000. 
...
You can see that your for your self!"
